...
pub struct ShotOnTwoLine {
    ...
    #[param(
        ...
        min = 5,
        max = 50,
        default_const = "DEFAULT_BOTTOM1_FONT_HEIGHT"
    )]
    pub first_font_height: u32,
    ...
    #[param(
        ...
        min = 5,
        max = 50,
        default_const = "DEFAULT_BOTTOM2_FONT_HEIGHT"
    )]
    pub second_font_height: u32,
...
impl Theme for ShotOnTwoLine {
    ...
    fn apply_to_dynamic_image(
        ...
        let first_txt = self.first.format_custom(exif);
        ...
        let second_txt = self.second.format_custom(exif);
    ...
    fn ui_config(&mut self, ui: &mut egui::Ui) {
        ...
        // Custom bottom_align UI and hint
        ui.vertical(|ui| {
            ui.add_space(4.0);
            egui::Grid::new("shot_on_two_line_custom")
                .num_columns(2)
                .spacing([4.0, 3.0])
                .show(ui, |ui| {
